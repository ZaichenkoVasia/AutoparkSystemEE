...
public class UserServiceImpl implements UserService {
    ...
    public boolean register(User user) {
        ...
        if (userDao.findByEmail(user.getEmail()).isPresent()) {
            ...
            throw new UserIsRegisteredRuntimeException("User is already registered by this e-mail");
        }
    ...
    public User login(String email, String password) {
        ...
        if (!entity.isPresent()) {
            ...
            throw new UserNotFoundRuntimeException("There is no user with this e-mail");
        } else {
