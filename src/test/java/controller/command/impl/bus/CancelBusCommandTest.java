...
public class CancelBusCommandTest {
    ...
    @InjectMocks
    private CancelBusCommand command;
    ...
    @Test
    public void executeShouldCancelBus() {
        ...
        verify(service).cancelBus(any(Integer.class), any(Integer.class));
