...
public class CancelDriverCommandTest {
    ...
    @InjectMocks
    private CancelDriverCommand command;
    ...
    @Test
    public void executeShouldCancelDriver() {
        when(request.getParameter(anyString())).thenReturn("1");
        when(service.cancelDriver(any(Integer.class))).thenReturn(true);
